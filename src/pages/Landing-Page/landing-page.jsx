...
export default function LandingPage(props) {
    ...
    //images
    const bgImg = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/Group732.png';
    const frame1 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/frame-654.png';
    const frame2 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/frame-851.png';
    const frame3 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/frame-852.png';
    const frame4 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/frame-854.png';
    const frame5 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/MacBook-Pro-6.png';
    const frame6 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/MacBook-Pro-16-579.png';
    // const WhatsappIcon2 = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/nav-bar-img/whatsapp_neon.svg';
    const logoImg = "https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/nav-bar-img/frame577.png";
    ...
    const CardTwo = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/Group841.png';
    const CardOne = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/Group840.png';
    const CardThree = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/Group849.png';
    const CardFour = 'https://rentblob.blob.core.windows.net/pitch/img/Pitch-Catalyst/landing-page/Group850.png';
    ...
    useEffect(() => {
        const handleScroll = event => {
            ...
            const OPScrolling = position >= scrollCount * 4 && position <= scrollCount + scrollHeight * 8 ? '1.3' :
                position >= scrollCount + scrollHeight * 8 && position <= scrollCount + scrollHeight * 12 ? '1.4' :
                    position >= scrollCount + scrollHeight * 12 && '2';

            const OPScrolling1 = staticAndInterActive > '0' && staticAndInterActive <= '0.2' ? '0.8' :
    ...
    return (
        <div className="landing-page-main-page" >
            ...
            <div className="nav-bar-container">
                ...
                <img src={logoImg} alt="" onClick={ScrollToTopFun} className='nav-bar-logo-img' />

                {!props.Query && <div onClick={() => { scrollToElement(elementOne) }}>CHAT</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementTwo) }}>Services</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementThree) }}>Features</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementFour) }}>Differentiator</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementFive) }}>Why Choose Us</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementSix) }}>Get Funded</div>
                }
                {!props.Query && <div onClick={() => { scrollToElement(elementSeven) }}>Packages</div>
                }
                {!props.Query && <Link to='/careers' className='link-tag'>Careers</Link>
                }
                ...
                {/* <div className="whatsapp-div">
                    <div className="inner-div">
                        <a href="https://wa.me/9711750002?text=Hey there, seeking deck expertise – can we sync up for a chat? " target="_blank" rel="noreferrer" >
            ...
            <Stickyroll pages={1} factor={1}>
                ...
                <div className="lp-contact-us-comp" ref={elementOne}>
                    <LPContactUsComp OPCompScrolling={OPCompScrolling} Query={props.Query} />
                </div>
            </Stickyroll>
            ...
            <div className="our-features-section" ref={elementThree}>
                ...
                <div className="card-container">
                    <div className="top-heading">OUR <br /> <span>FEATURES</span></div>

                    <div className="top-container">
                        {
                            cardGroupOneData.map((item, i) => {
                                return <OurFeatureComp key={i} Id={i} ImgURL={item.imgURL} Query={props.Query} Details={item.details} Heading={item.name} />
                            })
                        }
                    </div>
            ...
            >
                <div className="static-vs-interactive-deck-div" ref={elementFour}>
                    <div className="static-vs-interactive-heading">
                        STATIC <span>vs</span><br />
                        <b>interactive</b>
                    </div>
                    <div className="bg-blured-circle" />
                    <div className="card-one-div"
                        style={{
                            transform: staticAndInterActive >= 0.2 && staticAndInterActive < 0.6 && 'translateY(0vh)'
                        }}
                    >

                        {
                            !props.Query ? <img src={CardOne} alt="" />
                    ...
                    >
                        {
                            !props.Query ? <img src={CardTwo} alt="" />
