    ...
    return (
        <div className="left-menu-main-content">
            ...
            <div className="menu-div">
                <Link to='/clint-dashboard' className="menu-btn">
                    <span><img src={WD} alt="" /></span>
                    Dashboard
                </Link>
                <Link to='/clint-dashboard/analytics' className="menu-btn">
                    <span><img src={GA} alt="" /></span>
                    Analytics
                </Link>
                <Link to='/clint-dashboard/create-subdomain' className="menu-btn">
                    <span><img src={Laptop} alt="" /></span>
                    Sub-Domain
                </Link>
                <Link to='/clint-dashboard/pitch-ai' className="menu-btn">
                    <span><img src={Laptop} alt="" /></span>
                    Pitch - AI
                </Link>
            </div>
