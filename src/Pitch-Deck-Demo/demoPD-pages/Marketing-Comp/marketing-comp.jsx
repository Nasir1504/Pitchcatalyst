...
import MarketingNevBar from "./Nested-Comp/marketing-nev-bar";
import { ImageServer } from "../../../img/imageServer";
import MarketingSubComp from './Nested-Comp/Marketing-Sub-Comp/marketing-sub-comp';
            ...
            <div className="marketing-comp-main-container">
                ...
                <div className="left-part-div">
                                ...
                                <div className="headings">
                                    <h1
                                        style={{
                                            ...
                                            borderBottom: headingAnime && "1px solid #333333",
                                        }}
                                    >
                                        <span>CAMPAIGN</span> SLOGAN
                                    </h1>
                    ...
                    <div className="bottom-part-div">
                        {navItems === 0 && <MarketingSubComp HeadingAnime={headingAnime} />}
