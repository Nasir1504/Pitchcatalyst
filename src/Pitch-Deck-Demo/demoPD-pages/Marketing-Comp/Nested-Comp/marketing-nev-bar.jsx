...
import "./marketing-nev-bar.scss";
import NevItem from "./nev-item";
import TouchAppIcon from '@mui/icons-material/TouchApp';


export default function MarketingNevBar(props) {
    ...
    return (
        <>
            <div className="marketing-nev-bar-main-container">
                ...
                <div className="nev-item-two-div">
                    <button
                        ...
                        // onMouseLeave={() => { handleClick(0) }}
                        style={{
                            transform: props.NavItems === 2 && `scale(${1.5})`,
